...
exports.subscriptionService = {
     ...
     */
    createCheckoutSession: function (product) {
        return __awaiter(this, void 0, void 0, function () {
            var session, response, errorData, url, err_3;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    ...
                    case 1:
                        ...
                        return [4 /*yield*/, fetch("".concat(import.meta.env.VITE_SUPABASE_URL, "/functions/v1/stripe-checkout"), {
                                method: 'POST',
                                headers: {
                                ...
                                body: JSON.stringify({
                                    ...
                                    mode: product.mode,
                                    success_url: "".concat(window.location.origin, "/success?session_id={CHECKOUT_SESSION_ID}"),
                                    cancel_url: "".concat(window.location.origin, "/pricing"),
                                }),
                            })];
                    case 2:
                        response = _a.sent();
