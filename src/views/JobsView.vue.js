...
const filteredJobs = computed(() => {
    ...
    if (filters.value.search) {
        ...
        filtered = filtered.filter(job => job.jobNumber.toLowerCase().includes(search) ||
...
const confirmStatusUpdate = async () => {
    await jobsStore.updateJobStatus(statusUpdate.value.jobId, statusUpdate.value.status, statusUpdate.value.notes);
...
__VLS_asFunctionalElement(__VLS_intrinsicElements.select, __VLS_intrinsicElements.select)({
    value: (__VLS_ctx.filters.customer),
    ...{ class: "w-full px-3 py-2 border border-gray-300 rounded-md focus:ring-primary-500 focus:border-primary-500" },
});
__VLS_asFunctionalElement(__VLS_intrinsicElements.option, __VLS_intrinsicElements.option)({
    value: "",
});
for (const [customer] of __VLS_getVForSourceType((__VLS_ctx.uniqueCustomers))) {
    __VLS_asFunctionalElement(__VLS_intrinsicElements.option, __VLS_intrinsicElements.option)({
        key: (customer),
        value: (customer),
    });
...
if (__VLS_ctx.jobsStore.loading) {
    ...
    for (const [job] of __VLS_getVForSourceType((__VLS_ctx.filteredJobs))) {
        /** @type {[typeof JobCard, ]} */ ;
        // @ts-ignore
        const __VLS_4 = __VLS_asFunctionalComponent(JobCard, new JobCard({
            ...{ 'onUpdateStatus': {} },
            ...{ 'onViewDetails': {} },
            key: (job.id),
            job: (job),
...
if (__VLS_ctx.selectedJob) {
    ...
    // @ts-ignore
    const __VLS_12 = __VLS_asFunctionalComponent(JobDetailsModal, new JobDetailsModal({
        ...{ 'onClose': {} },
...
if (__VLS_ctx.showStatusModal) {
    ...
    __VLS_asFunctionalElement(__VLS_intrinsicElements.button, __VLS_intrinsicElements.button)({
        ...{ onClick: (__VLS_ctx.cancelStatusUpdate) },
