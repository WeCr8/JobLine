export type ConnectionType = 'google-sheets' | 'csv-upload' | 'rest-api' | 'sql-odbc' | 'sap-bapi' | 'webhook' | 'sftp';
...
export type ImportType = 'job-data' | 'operator-workcenter' | 'routing-operations' | 'cost-tracking' | 'customer-association';
