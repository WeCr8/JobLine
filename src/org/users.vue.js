...
var roleFilter = (0, vue_1.ref)('all');
var showInviteModal = (0, vue_1.ref)(false);
var showEditUserModal = (0, vue_1.ref)(false);
var sendingInvite = (0, vue_1.ref)(false);
var savingUser = (0, vue_1.ref)(false);
var newInvite = (0, vue_1.reactive)({
    email: '',
    role: 'operator',
    department: ''
});
...
var filteredUsers = (0, vue_1.computed)(function () {
    ...
    if (searchQuery.value) {
        ...
        filtered = filtered.filter(function (user) {
            return user.name.toLowerCase().includes(query_1) ||
                user.email.toLowerCase().includes(query_1);
        });
    }
    // Apply role filter
    if (roleFilter.value !== 'all') {
        filtered = filtered.filter(function (user) { return user.role === roleFilter.value; });
    }
    return filtered;
});
var refreshData = function () { return __awaiter(void 0, void 0, void 0, function () {
    ...
    return __generator(this, function (_a) {
        switch (_a.label) {
            ...
            case 1:
                _a.sent();
                return [4 /*yield*/, organizationStore.fetchInvites()];
            case 2:
                _a.sent();
...
var getDepartmentName = function (departmentId) {
    if (!departmentId)
        return 'None';
    var dept = departments.value.find(function (d) { return d.id === departmentId; });
    return dept ? dept.name : departmentId;
};
var sendInvite = function () { return __awaiter(void 0, void 0, void 0, function () {
    var error_2;
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0:
            ...
            case 1:
                ...
                return [4 /*yield*/, organizationStore.inviteUser(newInvite.email, newInvite.role, newInvite.department)];
            case 2:
                _a.sent();
...
var resendInvite = function (invite) { return __awaiter(void 0, void 0, void 0, function () {
    return __generator(this, function (_a) {
        try {
...
var cancelInvite = function (invite) { return __awaiter(void 0, void 0, void 0, function () {
    var error_3;
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0:
                _a.trys.push([0, 2, , 3]);
                return [4 /*yield*/, organizationStore.cancelInvite(invite.id)];
            case 1:
                _a.sent();
                return [3 /*break*/, 3];
            case 2:
                error_3 = _a.sent();
                console.error('Error cancelling invitation:', error_3);
                return [3 /*break*/, 3];
    ...
    return __generator(this, function (_a) {
        switch (_a.label) {
            ...
            case 1:
                ...
                return [4 /*yield*/, organizationStore.updateUser(editingUser.id, {
            ...
            case 3:
                error_4 = _a.sent();
                console.error('Error saving user:', error_4);
                return [3 /*break*/, 5];
            case 4:
...
var toggleUserStatus = function (user) { return __awaiter(void 0, void 0, void 0, function () {
    ...
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0:
                _a.trys.push([0, 2, , 3]);
                return [4 /*yield*/, organizationStore.updateUser(user.id, {
            ...
            case 2:
                error_5 = _a.sent();
                console.error('Error toggling user status:', error_5);
                return [3 /*break*/, 3];
            case 3: return [2 /*return*/];
        }
    });
...
__VLS_asFunctionalElement(__VLS_intrinsicElements.input)(__assign({ value: (__VLS_ctx.searchQuery), type: "text", placeholder: "Search users..." }, { class: "px-3 py-1 border border-gray-300 rounded-md text-sm focus:ring-primary-500 focus:border-primary-500" }));
__VLS_asFunctionalElement(__VLS_intrinsicElements.select, __VLS_intrinsicElements.select)(__assign({ value: (__VLS_ctx.roleFilter) }, { class: "px-3 py-1 border border-gray-300 rounded-md text-sm focus:ring-primary-500 focus:border-primary-500" }));
...
if (__VLS_ctx.pendingInvites.length === 0) {
    ...
    var _loop_2 = function (invite) {
        ...
        (invite.email);
        __VLS_asFunctionalElement(__VLS_intrinsicElements.td, __VLS_intrinsicElements.td)(__assign({ class: "px-6 py-4 whitespace-nowrap" }));
        __VLS_asFunctionalElement(__VLS_intrinsicElements.span, __VLS_intrinsicElements.span)(__assign({ class: "px-2 inline-flex text-xs leading-5 font-semibold rounded-full" }, { class: (__VLS_ctx.getRoleClass(invite.role)) }));
    ...
    for (var _b = 0, _c = __VLS_getVForSourceType((__VLS_ctx.pendingInvites)); _b < _c.length; _b++) {
        var invite = _c[_b][0];
        _loop_2(invite);
    }
}
if (__VLS_ctx.showInviteModal) {
    ...
    __VLS_asFunctionalElement(__VLS_intrinsicElements.form, __VLS_intrinsicElements.form)(__assign({ onSubmit: (__VLS_ctx.sendInvite) }, { class: "space-y-4" }));
    __VLS_asFunctionalElement(__VLS_intrinsicElements.div, __VLS_intrinsicElements.div)({});
    ...
    __VLS_asFunctionalElement(__VLS_intrinsicElements.div, __VLS_intrinsicElements.div)({});
    __VLS_asFunctionalElement(__VLS_intrinsicElements.label, __VLS_intrinsicElements.label)(__assign({ class: "block text-sm font-medium text-gray-700 mb-2" }));
    __VLS_asFunctionalElement(__VLS_intrinsicElements.select, __VLS_intrinsicElements.select)(__assign({ value: (__VLS_ctx.newInvite.role), required: true }, { class: "w-full px-3 py-2 border border-gray-300 rounded-md focus:ring-primary-500 focus:border-primary-500" }));
    __VLS_asFunctionalElement(__VLS_intrinsicElements.option, __VLS_intrinsicElements.option)({
        value: "organization_admin",
    });
    __VLS_asFunctionalElement(__VLS_intrinsicElements.option, __VLS_intrinsicElements.option)({
    ...
    __VLS_asFunctionalElement(__VLS_intrinsicElements.div, __VLS_intrinsicElements.div)({});
    __VLS_asFunctionalElement(__VLS_intrinsicElements.label, __VLS_intrinsicElements.label)(__assign({ class: "block text-sm font-medium text-gray-700 mb-2" }));
    __VLS_asFunctionalElement(__VLS_intrinsicElements.select, __VLS_intrinsicElements.select)(__assign({ value: (__VLS_ctx.newInvite.department) }, { class: "w-full px-3 py-2 border border-gray-300 rounded-md focus:ring-primary-500 focus:border-primary-500" }));
    __VLS_asFunctionalElement(__VLS_intrinsicElements.option, __VLS_intrinsicElements.option)({
        value: "",
    });
    for (var _d = 0, _e = __VLS_getVForSourceType((__VLS_ctx.departments)); _d < _e.length; _d++) {
        var dept = _e[_d][0];
        __VLS_asFunctionalElement(__VLS_intrinsicElements.option, __VLS_intrinsicElements.option)({
            key: (dept.id),
            value: (dept.id),
    ...
    __VLS_asFunctionalElement(__VLS_intrinsicElements.button, __VLS_intrinsicElements.button)(__assign({ type: "submit", disabled: (__VLS_ctx.sendingInvite) }, { class: "flex-1 bg-primary-600 text-white px-4 py-2 rounded-md text-sm font-medium hover:bg-primary-700 disabled:opacity-50 transition-colors duration-200" }));
...
if (__VLS_ctx.showEditUserModal) {
    ...
    __VLS_asFunctionalElement(__VLS_intrinsicElements.div, __VLS_intrinsicElements.div)({});
    __VLS_asFunctionalElement(__VLS_intrinsicElements.label, __VLS_intrinsicElements.label)(__assign({ class: "block text-sm font-medium text-gray-700 mb-2" }));
    __VLS_asFunctionalElement(__VLS_intrinsicElements.input)(__assign({ value: (__VLS_ctx.editingUser.name), type: "text", required: true }, { class: "w-full px-3 py-2 border border-gray-300 rounded-md focus:ring-primary-500 focus:border-primary-500" }));
    __VLS_asFunctionalElement(__VLS_intrinsicElements.div, __VLS_intrinsicElements.div)({});
    __VLS_asFunctionalElement(__VLS_intrinsicElements.label, __VLS_intrinsicElements.label)(__assign({ class: "block text-sm font-medium text-gray-700 mb-2" }));
    __VLS_asFunctionalElement(__VLS_intrinsicElements.input)(__assign({ type: "email", required: true, disabled: true }, { class: "w-full px-3 py-2 border border-gray-300 rounded-md bg-gray-100" }));
    ...
    for (var _f = 0, _g = __VLS_getVForSourceType((__VLS_ctx.departments)); _f < _g.length; _f++) {
        var dept = _g[_f][0];
        __VLS_asFunctionalElement(__VLS_intrinsicElements.option, __VLS_intrinsicElements.option)({
            key: (dept.id),
            value: (dept.id),
...
var __VLS_self = (await Promise.resolve().then(function () { return require('vue'); })).defineComponent({
    setup: function () {
        return {
            ...
            EnvelopeIcon: outline_1.EnvelopeIcon,
