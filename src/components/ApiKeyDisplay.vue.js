...
__VLS_asFunctionalElement(__VLS_intrinsicElements.input)(__assign({ type: "text", readonly: true, value: (__VLS_ctx.value) }, { class: "flex-1 px-3 py-2 border border-gray-300 rounded-l-md bg-gray-50 text-gray-500 font-mono text-sm" }));
__VLS_asFunctionalElement(__VLS_intrinsicElements.button, __VLS_intrinsicElements.button)(__assign({ onClick: (__VLS_ctx.copyToClipboard) }, { class: "px-3 py-2 bg-gray-100 text-gray-700 border border-l-0 border-gray-300 rounded-r-md hover:bg-gray-200 transition-colors duration-200" }));
var __VLS_0 = {}.ClipboardIcon;
