...
var analytics = (0, vue_1.ref)(adminStore.analytics);
...
var __VLS_0 = {}.CurrencyDollarIcon;
...
var __VLS_8 = {}.ArrowTrendingUpIcon;
...
var __VLS_12 = {}.ArrowTrendingDownIcon;
...
// @ts-ignore
var __VLS_17 = __VLS_asFunctionalComponent(__VLS_16, new __VLS_16(__assign({ to: "/admin/organizations" }, { class: "text-primary-600 hover:text-primary-700 text-sm font-medium" })));
var __VLS_18 = __VLS_17.apply(void 0, __spreadArray([__assign({ to: "/admin/organizations" }, { class: "text-primary-600 hover:text-primary-700 text-sm font-medium" })], __VLS_functionalComponentArgsRest(__VLS_17), false));
...
for (var _i = 0, _a = __VLS_getVForSourceType((__VLS_ctx.organizations.slice(0, 5))); _i < _a.length; _i++) {
    var org = _a[_i][0];
    __VLS_asFunctionalElement(__VLS_intrinsicElements.tr, __VLS_intrinsicElements.tr)({
        key: (org.id),
    });
...
for (var _b = 0, _c = __VLS_getVForSourceType((__VLS_ctx.analytics.planDistribution)); _b < _c.length; _b++) {
    var _d = _c[_b], count = _d[0], plan = _d[1];
    __VLS_asFunctionalElement(__VLS_intrinsicElements.div, __VLS_intrinsicElements.div)(__assign({ key: (plan) }, { class: "bg-gray-50 rounded-lg p-4" }));
    ...
    (plan);
    __VLS_asFunctionalElement(__VLS_intrinsicElements.div, __VLS_intrinsicElements.div)(__assign({ class: "text-3xl font-bold text-primary-600 mt-2" }));
    (count);
    __VLS_asFunctionalElement(__VLS_intrinsicElements.div, __VLS_intrinsicElements.div)(__assign({ class: "text-sm text-gray-500 mt-1" }));
}
