...
var savingGlobalSettings = (0, vue_1.ref)(false);
// Global settings
var globalSettings = (0, vue_1.ref)({
    apiRateLimit: 60,
    apiTimeout: 30,
    maxBatchSize: 1000,
    maxFileSize: 10,
...
// Mock data for logs
var integrationLogs = (0, vue_1.ref)([
    {
        id: '1',
...
var filteredLogs = (0, vue_1.computed)(function () {
    ...
    return integrationLogs.value.filter(function (log) { return log.level === logLevel.value; });
});
// Methods
...
var saveGlobalSettings = function () { return __awaiter(void 0, void 0, void 0, function () {
    var error_1;
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0:
            ...
            case 3:
                error_1 = _a.sent();
                console.error('Error saving global settings:', error_1);
...
var viewOrgIntegrations = function (org) {
...
var resetOrgIntegrations = function (org) {
    if (confirm("Are you sure you want to reset all integrations for ".concat(org.name, "? This will delete all connections and import history."))) {
...
var formatTime = function (timestamp) {
    return (0, date_fns_1.format)(new Date(timestamp), 'MMM dd, yyyy HH:mm:ss');
};
...
__VLS_asFunctionalElement(__VLS_intrinsicElements.form, __VLS_intrinsicElements.form)(__assign({ onSubmit: (__VLS_ctx.saveGlobalSettings) }, { class: "space-y-6" }));
__VLS_asFunctionalElement(__VLS_intrinsicElements.div, __VLS_intrinsicElements.div)({});
__VLS_asFunctionalElement(__VLS_intrinsicElements.h3, __VLS_intrinsicElements.h3)(__assign({ class: "text-md font-medium text-gray-900 mb-4" }));
...
__VLS_asFunctionalElement(__VLS_intrinsicElements.div, __VLS_intrinsicElements.div)({});
__VLS_asFunctionalElement(__VLS_intrinsicElements.label, __VLS_intrinsicElements.label)(__assign({ class: "block text-sm font-medium text-gray-700 mb-2" }));
__VLS_asFunctionalElement(__VLS_intrinsicElements.input)(__assign(__assign({ type: "password" }, { class: "w-full px-3 py-2 border border-gray-300 rounded-md focus:ring-primary-500 focus:border-primary-500" }), { placeholder: "Enter Google API key" }));
(__VLS_ctx.globalSettings.googleApiKey);
__VLS_asFunctionalElement(__VLS_intrinsicElements.div, __VLS_intrinsicElements.div)({});
__VLS_asFunctionalElement(__VLS_intrinsicElements.label, __VLS_intrinsicElements.label)(__assign({ class: "block text-sm font-medium text-gray-700 mb-2" }));
__VLS_asFunctionalElement(__VLS_intrinsicElements.div, __VLS_intrinsicElements.div)(__assign({ class: "grid grid-cols-1 md:grid-cols-2 gap-4" }));
__VLS_asFunctionalElement(__VLS_intrinsicElements.input)(__assign(__assign({ value: (__VLS_ctx.globalSettings.sapUsername), type: "text" }, { class: "w-full px-3 py-2 border border-gray-300 rounded-md focus:ring-primary-500 focus:border-primary-500" }), { placeholder: "Username" }));
__VLS_asFunctionalElement(__VLS_intrinsicElements.input)(__assign(__assign({ type: "password" }, { class: "w-full px-3 py-2 border border-gray-300 rounded-md focus:ring-primary-500 focus:border-primary-500" }), { placeholder: "Password" }));
...
// @ts-ignore
var __VLS_4 = __VLS_asFunctionalComponent(ToggleSwitch_vue_1.default, new ToggleSwitch_vue_1.default({
...
/** @type {[typeof ToggleSwitch, ]} */ ;
// @ts-ignore
var __VLS_7 = __VLS_asFunctionalComponent(ToggleSwitch_vue_1.default, new ToggleSwitch_vue_1.default({
...
/** @type {[typeof ToggleSwitch, ]} */ ;
// @ts-ignore
var __VLS_10 = __VLS_asFunctionalComponent(ToggleSwitch_vue_1.default, new ToggleSwitch_vue_1.default({
...
__VLS_asFunctionalElement(__VLS_intrinsicElements.button, __VLS_intrinsicElements.button)(__assign({ type: "submit", disabled: (__VLS_ctx.savingGlobalSettings) }, { class: "bg-primary-600 text-white px-4 py-2 rounded-md text-sm font-medium hover:bg-primary-700 disabled:opacity-50 transition-colors duration-200" }));
...
var _loop_1 = function (org) {
    ...
    __VLS_asFunctionalElement(__VLS_intrinsicElements.td, __VLS_intrinsicElements.td)(__assign({ class: "px-6 py-4 whitespace-nowrap" }));
    __VLS_asFunctionalElement(__VLS_intrinsicElements.span, __VLS_intrinsicElements.span)(__assign({ class: "px-2 inline-flex text-xs leading-5 font-semibold rounded-full" }, { class: (org.status === 'active' ? 'bg-green-100 text-green-800' : 'bg-red-100 text-red-800') }));
...
for (var _i = 0, _a = __VLS_getVForSourceType((__VLS_ctx.organizations)); _i < _a.length; _i++) {
    var org = _a[_i][0];
    _loop_1(org);
}
__VLS_asFunctionalElement(__VLS_intrinsicElements.div, __VLS_intrinsicElements.div)(__assign({ class: "bg-white rounded-lg shadow-sm border border-gray-200" }));
...
var __VLS_16 = {}.ArrowPathIcon;
/** @type {[typeof __VLS_components.ArrowPathIcon, ]} */ ;
// @ts-ignore
var __VLS_17 = __VLS_asFunctionalComponent(__VLS_16, new __VLS_16(__assign({ class: "w-4 h-4" })));
var __VLS_18 = __VLS_17.apply(void 0, __spreadArray([__assign({ class: "w-4 h-4" })], __VLS_functionalComponentArgsRest(__VLS_17), false));
__VLS_asFunctionalElement(__VLS_intrinsicElements.div, __VLS_intrinsicElements.div)(__assign({ class: "p-6" }));
__VLS_asFunctionalElement(__VLS_intrinsicElements.div, __VLS_intrinsicElements.div)(__assign({ class: "overflow-x-auto" }));
__VLS_asFunctionalElement(__VLS_intrinsicElements.table, __VLS_intrinsicElements.table)(__assign({ class: "min-w-full divide-y divide-gray-200" }));
__VLS_asFunctionalElement(__VLS_intrinsicElements.thead, __VLS_intrinsicElements.thead)(__assign({ class: "bg-gray-50" }));
...
__VLS_asFunctionalElement(__VLS_intrinsicElements.th, __VLS_intrinsicElements.th)(__assign({ scope: "col" }, { class: "px-6 py-3 text-left text-xs font-medium text-gray-500 uppercase tracking-wider" }));
__VLS_asFunctionalElement(__VLS_intrinsicElements.tbody, __VLS_intrinsicElements.tbody)(__assign({ class: "bg-white divide-y divide-gray-200" }));
for (var _b = 0, _c = __VLS_getVForSourceType((__VLS_ctx.filteredLogs)); _b < _c.length; _b++) {
    var log = _c[_b][0];
    __VLS_asFunctionalElement(__VLS_intrinsicElements.tr, __VLS_intrinsicElements.tr)({
        key: (log.id),
    });
