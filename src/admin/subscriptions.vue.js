...
const filteredSubscriptions = computed(() => {
    ...
    if (searchQuery.value) {
        ...
        filtered = filtered.filter(sub => sub.userName.toLowerCase().includes(query) ||
...
const viewInvoices = (subscription) => {
...
for (const [sub] of __VLS_getVForSourceType((__VLS_ctx.filteredSubscriptions))) {
    __VLS_asFunctionalElement(__VLS_intrinsicElements.tr, __VLS_intrinsicElements.tr)({
        key: (sub.id),
    });
    ...
    __VLS_asFunctionalElement(__VLS_intrinsicElements.span, __VLS_intrinsicElements.span)({
        ...
        ...{ class: (__VLS_ctx.getSubscriptionStatusClass(sub.status)) },
    });
...
if (__VLS_ctx.showInvoicesModal) {
    ...
    (__VLS_ctx.selectedSubscription?.userName);
    __VLS_asFunctionalElement(__VLS_intrinsicElements.button, __VLS_intrinsicElements.button)({
        ...{ onClick: (...[$event]) => {
                if (!(__VLS_ctx.showInvoicesModal))
                    return;
    ...
    for (const [invoice] of __VLS_getVForSourceType((__VLS_ctx.selectedSubscription?.invoices))) {
        __VLS_asFunctionalElement(__VLS_intrinsicElements.tr, __VLS_intrinsicElements.tr)({
            key: (invoice.id),
        });
        __VLS_asFunctionalElement(__VLS_intrinsicElements.td, __VLS_intrinsicElements.td)({
        ...
        __VLS_asFunctionalElement(__VLS_intrinsicElements.span, __VLS_intrinsicElements.span)({
            ...{ class: "px-2 inline-flex text-xs leading-5 font-semibold rounded-full" },
            ...{ class: (__VLS_ctx.getInvoiceStatusClass(invoice.status)) },
        });
...
if (__VLS_ctx.showCancelModal) {
    ...
    (__VLS_ctx.formatDate(__VLS_ctx.selectedSubscription?.nextBillingDate || ''));
    __VLS_asFunctionalElement(__VLS_intrinsicElements.div, __VLS_intrinsicElements.div)({
        ...{ class: "flex space-x-3 mt-6" },
    });
    __VLS_asFunctionalElement(__VLS_intrinsicElements.button, __VLS_intrinsicElements.button)({
        ...{ onClick: (__VLS_ctx.confirmCancelSubscription) },
